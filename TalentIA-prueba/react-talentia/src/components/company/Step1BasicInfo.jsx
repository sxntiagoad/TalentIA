...
const Step1BasicInfo = ({ nextStep, handleChange, values }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6">
      <h2 className="text-2xl font-bold text-green-600 mb-6">Paso 1: Información Básica del Trabajo</h2>
      <form onSubmit={continuar}>
        <div className="mb-4">
          <label htmlFor="title" className="block text-sm font-medium text-gray-700 mb-2">Título del trabajo</label>
          <input
            type="text"
