...
import { getReviewsByRevieweeId } from '../../../api/Reviews.api';
...
// Componente para moointr la distribución de calificaciones
...
function Reviews() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white px-10 py-5 text-gray-800 mt-16"> {/* Agrega un margin-top para evitar superposición */}
