...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(models.Q(('job__isnull', True), ('service__isnull', False)), models.Q(('job__isnull', False), ('service__isnull', True)), _connector='OR'), name='review_service_or_job')],
            },
        ),
    ]
